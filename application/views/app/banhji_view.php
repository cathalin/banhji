			...
			<div class="span12" id="voucherContainer">
				<table class="table">
					<tr>
						...
						<td><input type="date" style="width: 220px;" data-role="datepicker" data-bind="value: current.date" data-format="dd-MM-yyyy"></td>
					</tr>
					<tr>
						<td>ចំណាត់ថ្នាក់ៈ</td>
						<td><input type="text" style="width: 220px;" data-role="combobox" 
																	 data-bind="source: classDS, value: current.class_id" 
																	 data-text-field="name" 
					...
					<tr>
						...
						<td><input type="text" data-bind="source: accounts, value: account" 
											   data-text-field="name" 
											   data-value-field="id"
											   data-role="combobox"
				...
				<div class="span3 offset9">
					<table class="table">
						<tr>
							<td>រើសពន្ធៈ</td>
							<td><input type="text" data-role="combobox" 
									   data-bind="source: vats, value: vat, events: {change: selectTax}" 
									   data-text-field="name" 
									   data-value-field="id"
									   data-placeholder="---រើសមួយ---"
									   style="width: 100%"></td>
						...
						<tr>
							<td>ពន្ធៈ</td>
							<td><span data-bind="text: taxAmount"></span></td>
						</tr>
						<tr>
							<td>សរុបរួមៈ</td>
...
<script id="cartTmpl" type="text/x-kendo-template">
	<tr>
		...
		<td style="padding-bottom: 1px;"><input type="text" style="width: 93%; margin-bottom:3px;" data-bind="value: cost, events: {change: itemTotal}"></td>
		<td style="padding-bottom: 1px;"><input type="text" style="width: 87%; margin-bottom:3px;" data-bind="value: quantity, events: {change: itemTotal}"></td>
				...
				<div class="row-fluid">					
					...
					<div class="span3">
			            ...
			            <select id="ar" name="ar" data-role="dropdownlist" 
			            		data-text-field="name" data-value-field="id" data-value-primitive="true" 
	            				data-bind="source: accountList, value: customer.account_receiveable_id" 
	            				data-option-label="(--- ជ្រើសរើស ---)"	            				
				            	...
				            	<table width="100%" cellpadding="5" cellspacing="5">							            
						            ...
						            <tr>
						                ...
						                <td><select id="ampere" name="ampere" data-role="dropdownlist" 
						                			data-text-field="ampere" data-value-field="id" data-value-primitive="true"
						            ...
						            <tr>
						                ...
						                <td><select id="phase" name="phase" data-role="dropdownlist" 
						                			data-text-field="phase" data-value-field="id" data-value-primitive="true"
						            ...
						            <tr>
						                ...
						                <td><select id="voltage" name="voltage" data-role="dropdownlist" 
						                			data-text-field="voltage" data-value-field="id" data-value-primitive="true"
					                ...
					                <td>កាលកំណត់</td>
					              	<td>
					              		<select data-role="dropdownlist" data-text-field="term" 
					              				data-value-field="id" data-bind="source: paymentTermList, value: invoice.payment_term_id" 
								...
								<tr align="right">
									<td align="top">
										<select data-role="combobox" 
												...
												placeholder="VAT" style="width:90px"></select>								
									</td>
			...
			<div class="span12">
				...
				<div id="meter-window" data-role="window" data-visible="false" data-modal="true" data-resizable="false" data-iframe="true" data-min-width="600px" data-height="400px">
			    	<table cellpadding="5" cellspacing="5">
		                <tr>
		                  	...
		                  	<td><input data-role="datepicker" data-bind="value: meter.date_used" data-format="dd-MM-yyyy" /></td> 
		                </tr>
		                <tr>
		                  	<td>ប្រភេទ</td>
		                  	...
		                  	<td>កុងទ័របំរុងនៃ</td>
		                  	<td><select data-role="combobox" 
		                  				data-text-field="meter_no" data-value-field="id" 
		                  				data-auto-bind="false"
		                  				data-value-primitive="true" data-bind="source: parentMeterList, value: meter.parent_id"></select></td>	                  	                             
		                </tr>
		                <tr>
		                ...
		                <tr>             
		                  <td>សំណគំរបខ្សែ</td>
		                  	<td><select data-role="dropdownlist" data-text-field="name" data-value-field="value" data-value-primitive="true" data-bind="source: hasOrNot, value: meter.cover_sealed"></select></td>	                  	  	             
		                  	<td>ស្ថានភាព</td>
		                ...
		                <tr>             
		                  	<td>សំណត្រចៀក</td>
		                  	<td><select data-role="dropdownlist" data-text-field="name" data-value-field="value" data-value-primitive="true" data-bind="source: hasOrNot, value: meter.ear_sealed"></select></td>	                  	  	
		                  	<td></td>
		                ...
		                <tr>
		                	...
		                	<td><input data-role="numerictextbox" data-bind="value: meter.max_digit" data-format="n0" min="0" placeholder="ឧ.10000" /></td>                  	
		                  	<td>តំលៃ</td>
		                  	<td><select data-role="combobox" data-text-field="name" data-value-field="id" data-value-primitive="true" data-bind="source: tariffList, enabled: hasTariff, value: meter.tariff_id"></select></td>	                  	                        
		                </tr>
		                <tr>
		                  	<td>ត្រង់ស្វូ</td>
		                  	<td><select data-role="combobox" data-text-field="transformer_number" data-value-field="id" data-value-primitive="true" data-bind="source: transformerList, value: meter.transformer_id"></select></td>	                  	
		                ...
		                <tr>
		               	  	<td>ប្រអប់</td>
		                  	<td><select data-role="combobox" data-text-field="box_no" data-value-field="id" data-value-primitive="true" data-bind="source: electricityBoxList, value: meter.electricity_box_id"></select></td>
		                  	<td></td>
		                  	<td></td>
		                </tr>
		          	</table>
				...
				<div id="breaker-window" data-role="window" data-visible="false" data-modal="true" data-resizable="false" data-iframe="true" data-min-width="300px" data-height="250px">
			    	<table cellpadding="5" cellspacing="5">
		                ...
		                <tr>                 
		                  	<td>ថ្ងៃប្រើប្រាស់</td>	                  	
		                  	<td><input data-role="datepicker" data-bind="value: breaker.date_used" data-format="dd-MM-yyyy" /></td> 
		                </tr>
		                <tr>
		                  	<td>ប្រភេទ</td>
		                  	<td><select data-role="combobox" 
...
<script>
			...
			filterBy 	: function(filters) {
				...
				this.get('dataSource').bind('requestEnd', function(e){
					if(e.response.error === "false") {
						...
						dfd.resolve(e.response.message);
					}
		...
		var viewModel = kendo.observable({
			...
			newTrnx 	: function() {
				this.database.insert(0, {
					company_id: banhji.config.userData.company,
					people_id: viewModel.get("vendor").id,
			...
			save: function(){
				...
				this.get("database").bind("requestEnd", function(e){
					...
					if(res.status === "OK") {
						...
						dfd.reject("មានភាគរអាករអួលពេលកត់ត្រា។");
					}
					return dfd.promise();
				});
	...
	banhji.voucher = (function(){
		...
		var viewModel = kendo.observable({
			...
			newVoucher 	: function() {
				...
				this.setCurrent(banhji.transaction.database.at(0));
			},
			...
			vat 		: "",
			paymentTerm : null,
			journalEntries: new kendo.data.DataSource({
				transport: {
					read: {
			...
			addToCart 	: function() {
				if(this.get("type") === "purchase") {
					...
					this.cart.push({account_id: "", amount: 0, memo: "", class_id: ""});
				}
			},
			...
			itemTotal 	: function(e) {
				if(this.get("type") === "purchase") {
					for(var i=0;i<this.cart.length;i++) {
						var current = this.cart[i];
						if(current === e.data) {
							var amount = this.cart[i].cost * this.cart[i].quantity;
			...
			selectTax 	: function(e) {
				this.set('vat', kendo.parseFloat(this.get("vatDS").at(e.sender.selectedIndex).price));
				...
				this.set("taxAmount", kendo.toString(amount * this.get("vat"), '##,#.00'));
			},
			subTotal 	: function() {
				var amount = 0;
				var cart = this.get("cart");
			...
			save 		: function() {
				...
				if(!this.get('current')) {
					...
					banhji.transaction.save({
						...
						payment_term_id: this.get("cashPayment") === true ? "": this.get("paymentTerm").id,
						transaction_type: this.get("type"),
						payment_method: this.get("cashPayment") === true ? "cash" : "non-cash",
						...
						amount_due: this.get("cashPayment") === true ? 0:kendo.parseFloat(this.grandTotal()) * kendo.parseFloat(banhji.currency.getEX(banhji.vendor.get("current").currency_code, banhji.currency.getCompanyCurrency(banhji.config.userData.company))),
					...
					for(var i=0; i < this.cart.length; i++) {
						this.journalEntries.push({
					 		...
					 		cr: 0,
					 		class_id: this.get("class_id"), 
					 		memo: this.cart[i].memo,
					 		exchange_rate: banhji.currency.getEX(banhji.vendor.get("current").currency_code, banhji.currency.getCompanyCurrency(banhji.config.userData.company)),
					 		main: 0
						});
					}
					var entries = this.journalEntries;
					var data = 	{
							company_id: String(banhji.config.userData.company),
							people_id: viewModel.get("vendor").id,
							employee_id: String(banhji.config.userData.userId),
							payment_id: this.get("cashPayment") === true ? this.get("paymentTerm"): "",
							payment_term_id: this.get("cashPayment") === true ? "0": this.get("paymentTerm").id,
							transaction_type: this.get("type"),
							payment_method: this.get("cashPayment") === true ? "cash" : "non-cash",
							check_no: this.get("checkNo"),
							memo: this.get("description"),
							date: kendo.toString(this.get("date"), "yyyy-MM-dd"),
							dueDate: this.get("cashPayment") === true ? "0000-00-00": this.dueDate(),
							amount_billed: kendo.parseFloat(this.grandTotal()) * kendo.parseFloat(banhji.currency.getEX(banhji.vendor.get("current").currency_code, banhji.currency.getCompanyCurrency(banhji.config.userData.company))),
							amount_due: 0,
							amount_paid: this.get("cashPayment") === true ? kendo.parseFloat(this.grandTotal()) * kendo.parseFloat(banhji.currency.getEX(banhji.vendor.get("current").currency_code, banhji.currency.getCompanyCurrency(banhji.config.userData.company))) : 0,
							voucher: this.get("voucher"),
							invoice_id: this.get("invoice"),
							class_id: this.get("class").id,
							status: this.get("cashPayment") === true ? "1" : "0",
							reference: this.get("po") === null ? '""':this.get("po").id,
							journalEntries: this.journalEntries							
						};
					for(i in data){
						if(data[i] != this.get('current')[i] && i !== "journalEntries") {
							this.get('current').set(i, data[i]);
						}
					};
					// if(this.get("current").dirty) {
					// 	banhji.transaction.database.sync();
					// 	banhji.transaction.database.bind('requestEnd', function(e){
					// 		viewModel.reset();
					// 	});
					// }
				}				
	...
	banhji.expenseVoucher = (function(){
		var viewModel = kendo.observable({
			voucher 	: banhji.voucher,
			journalEntry: banhji.journalEntry
		});
		return viewModel;
	}());

	banhji.purchaseVoucher = (function(){
		var viewModel = kendo.observable({
			accounts 	: [],
			acctList 	: [],
			new 	 	: function() {
			...
			setCurrent 	: function(voucher) {
				this.set("current", voucher);
			},
			closeX 	: function () {
				//kendo.fx($("#purchase-form")).slideIn("up").play();
				window.history.go(-1);
	...
	banhji.purchase = (function(){
		...
		var viewModel = kendo.observable({
			...
			currentVendor: banhji.vendor.get("current"),
			items 		: [],
			vatDS 		: [],
			...
			vendor  	: "",
			billed 		: false,
			cart 		: [{bill_id: 0, item_id: "", description: "", quantity: 0, cost: 0, price: 0, amount: 0, account_id: 0, taxed: false}],
			journalEntries: [],
			paidCash   	: true,
			checkoutBtn	: false,
			date 		: new Date(),
		   ...
		   //  	}	
			...
			sync 			: function(billId) {
				var rate = 1;// banhji.currency.getEX(banhji.get("currency"),banhji.currency.getCompanyCurrency(banhji.config.userData.company));
				...
				itemRecordDS.bind('requestEnd', function(e){
					//empty to prepare datasource for new insertion
					if(viewModel.cart.length > 0) {		
						for(var i = 0; i < viewModel.cart.length; i++) {
							itemRecordDS.remove(itemRecordDS.at(i))
						}
						viewModel.cart.splice(0, viewModel.cart.length);
						viewModel.set("creditAcct", "");
						viewModel.set("paymentTerm", "");
						viewModel.set("pmtMethod", "");	
						$("#purchaseStatus").addClass("alert alert-primary").text("កត់ត្រាបានសំរេច");
					}
				});
			}
		});
	...
	banhji.customerCenter = (function(){
		...
		var viewModel = kendo.observable({
			...
			goDetail		: function(e){
				...
				banhji.customer.viewModel.set("customer", cus);
				banhji.customer.viewModel.set("customer_no_origin", cus.number);				
				...
				if(!this.get("detailLoaded")){
					...
					$("#save").click(function(e){
			            ...
			            if(validator.validate() && isExistingNumber===false){
			            	banhji.customer.viewModel.save();
			...
			goEReadingSingle	: function(e){
				...
				banhji.view.customerCenter.showIn("#detail", banhji.view.eReadingSingle);

				if(!this.get("eReadingSingleLoaded")){				
					banhji.eReadingSingle.viewModel.pageLoad(this.get("customer").id);
	...
	banhji.customer = (function(){
		...
		var viewModel = kendo.observable({
			...
			addEmpty 		: function(){
				...
				this.set("customer", customerDS.at(0));	
			},
			save 			: function(){				
				customerDS.sync();
			},		
	...
	banhji.invoice = (function(){		
		...
		var viewModel = kendo.observable({											
					...
					.then(
						function(data){
							var d = data[0];
						  	...
						  	var parent_company_id = d.companies.id;
						  	if(d.companies.parent_id>0){
						  		parent_company_id = d.companies.parent_id;					  		
						  	}
						  	
						  	self.loadClass(parent_company_id);
						  	self.setItemSource(type, parent_company_id);
		    ...
		    setItemSource 		: function(type, company_id){
		    	...
		    	var current_id = this.get("company_id");
			...
			loadClass 			: function(company_id){
				var current_id = this.get("parent_company_id");
				if(current_id!==company_id){
					this.set("parent_company_id", company_id);
			...
			loadEdit 			: function(invoice_id){
				...
				this.loadInvoice(invoice_id).then(
					function(data){
						...
						var parent_company_id = d.company_id;												
					  	if(d.companies.parent_id!=="0"){
					  		parent_company_id = d.companies.parent_id;					  		
					  	}

					  	self.setItemSource(d.type, parent_company_id);
			  			self.set("customer", d.customers);
					...
					function(invoice){												
						...
						var t = kendo.parseFloat(invoice.amount)/invoice.rate;
				  		...
				  		inv.set("vat_id", "");
						inv.set("amount", kendo.toString(t, "c", invoice.sub_code));
						inv.set("vat", kendo.toString(v, "c", invoice.sub_code));
						inv.set("issued_date", new Date(invoice.issued_date));
						inv.set("due_date", new Date(invoice.due_date));

						invoiceItemDS.filter({ field: "invoice_id", value: invoice_id });
					}
				);
			},
		    loadCustomer 		: function(id){
		...
		var viewModel = kendo.observable({
			...
			loadMeter 			: function(customer_id){
    				...
    				if(type==="read"){
    					for (var i=0;i<response.length;i++) {
    						...
    						if((d.parent_id="0") && (d.status="1")){    							    							
    							self.get("parentMeterList").push(d);
    						}	
    					}
    				}
	      		});				
	      	...
	      	closeMeterWindow 	: function(){
	      		meterDS.cancelChanges();

	      		var window = $("#meter-window").data("kendoWindow");          	         	
	          	window.center().close();
	      	},
	      	meterGridChange		: function(eventArgs) {
	        	var selectedMeter = eventArgs.sender.dataItem(eventArgs.sender.select());
	        	var meter = meterDS.get(selectedMeter.id);
	        	meter.set("date_used", new Date(meter.date_used));

	        	this.set("meter", meter);
	        	this.set("selectedRow", selectedMeter);

	         	this.set("isEditMode", true);
	         	this.set("meter_id", selectedMeter.id);
	      	...
	      	closeBreakerWindow 	: function(){
	      		breakerDS.cancelChanges();

	      		var window = $("#breaker-window").data("kendoWindow");          	         	
	          	window.center().close();
	      	},   
	      	breakerGridChange		: function(eventArgs) {
	        	var selectedBreaker = eventArgs.sender.dataItem(eventArgs.sender.select());
	        	var breaker = breakerDS.get(selectedBreaker.id);
	        	breaker.set("date_used", new Date(breaker.date_used));

	        	this.set("breaker", breaker);
	        	
	         	this.set("isEditModeBrker", true);
	         	this.set("breaker_id", selectedBreaker.id);
	      	...
	      	breakerSaveClick 		: function(){
	      		breakerDS.sync();
	      		breakerDS.bind("requestEnd", function(e){
	      			var response = e.response;
    				var type = e.type;
	...
	banhji.eReadingSingle = (function(){
		...
		var viewModel = kendo.observable({
			...
			add 	: function(){
				...
				for (var i=0;i<customerDS.total();i++) {
					...
					var rate = this.getRate(d.companies.based_currency, d.currency_code);
	...
	banhji.view = (function(){
		...
		var eReadingSingle = new kendo.View("#eReadingSingle", {model: banhji.eReadingSingle.viewModel});
	...
	banhji.router.route("customers", function(){
		...
		if(vm.get("customer") === null){		
			...
			var grid = $("#sidebar").kendoGrid({
				dataSource: banhji.customer.viewModel.get("customerList"),							
				selectable: true,
				columns: [
					{ title: ""}
				],
				...
				change: function(){
					...
					var balance = kendo.toString(kendo.parseFloat(data.balance), "c", data.currencies.sub_code)
	...
	banhji.router.route("new_customer", function(){
		...
		$("#save").click(function(e){
            ...
            if(validator.validate() && isExistingNumber===false){
            	banhji.customer.viewModel.save();
            	banhji.customer.viewModel.clear();
	...
	banhji.router.route("eReading", function(){
        ...
        var products = $("#transformer").kendoDropDownList({
            autoBind: false,
            cascadeFrom: "company",
            optionLabel: "(--- រើស តំបន់ ---)",
            dataTextField: "transformer_number",
	...
	banhji.router.route("purchase(/:id)", function(id){
		...
		if(id!==undefined) {
			...
			banhji.transaction.database.bind("change", function(e){
				// if(banhji.currency.getCompanyCurrency(banhji.config.userData.company) !== model.people_name.currency_code) {
				// 	FX = parseFloat(model.journalEntries[0].exchange_rate);
				// }
				var model = this.data()[0];
				banhji.voucher.setCurrent(model);
				banhji.voucher.set("vendor", model.people_name);
				banhji.voucher.set("voucher", model.voucher);
				banhji.voucher.set("class", model.class_name);
				banhji.voucher.set("account", model.journalEntries[0].account);
				banhji.voucher.set("description", model.memo);
				banhji.voucher.set("invoiceNumber", model.invoice_id);
				banhji.voucher.set("checkNo", model.check_no);
				banhji.voucher.set("date", model.date);
				banhji.voucher.set("cashPayment", model.payment_method === "cash"? true: false);
				banhji.voucher.set("paymentTerm", model.payment_method === "cash"? model.payment_id: model.payment_term_id);
				if(model.entries) {
					banhji.voucher.get("cart").splice(0,banhji.voucher.get("cart").length);
					$.each(model.entries, function(i,v){
						if(v.main !== "1") {
							banhji.voucher.cart.splice(0,banhji.voucher.cart.length);
							banhji.voucher.cart.push({
								bill_id: v.bill_id, 
								item_id: v.item_id, 
								description: v.description, 
								quantity: v.quantity, 
	...
	banhji.router.route("expense(/:id)", function(id){
		...
		if(id!==undefined) {
			...
			banhji.transaction.database.bind("change", function(e){
				...
				banhji.voucher.set("cashPayment", model.payment_method === "cash"? true: false);
				banhji.voucher.set("paymentTerm", model.payment_method === "cash"? model.payment_id: model.payment_term_id);
				$.each(model.journalEntries, function(i,v){
					if(v.main !== "1") {
						banhji.voucher.cart.splice(0,banhji.voucher.cart.length);
						banhji.voucher.cart.push({
